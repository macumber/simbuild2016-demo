module OsLib_QAQC
  ...
  def check_envelope_conductance(category,target_standard,min_pass,max_pass)
    ...
    begin
      ...
      @model.getSpaceTypes.each do |space_type|
        ...
        if missing_surface_constructions.size > 0
        ...
        if missing_sub_surface_constructions.size > 0
        ...
        surface_details.uniq.each do |surface_detail|
          if surface_detail[:construction].thermalConductance.is_initialized
            ...
            if solar_reflectance < target_reflectance[surface_detail[:surface_type]]*(1.0 - min_pass) and target_standard != "ICC IECC 2015"
            ...
            elsif solar_reflectance > target_reflectance[surface_detail[:surface_type]]*(1.0 + max_pass) and target_standard != "ICC IECC 2015"
        ...
        sub_surface_details.uniq.each do |sub_surface_detail|
          if sub_surface_detail[:surface_type] == "FixedWindow" || sub_surface_detail[:surface_type] == "OperableWindow" || sub_surface_detail[:surface_type] == "Skylight"
            ...
            if sub_surface_detail[:construction].thermalConductance.is_initialized
              ...
              # check solar reflectance
              if solar_reflectance < target_reflectance[sub_surface_detail[:surface_type]]*(1.0 - min_pass) and target_standard != "ICC IECC 2015"
              ...
              elsif solar_reflectance > target_reflectance[sub_surface_detail[:surface_type]]*(1.0 + max_pass) and target_standard != "ICC IECC 2015"
        ...
        if not space.spaceType.is_initialized
          ...
          surface_details.uniq.each do |surface_detail|
            ...
            if surface_detail[:construction].thermalConductance.is_initialized
              ...
              # check solar reflectance
              if solar_reflectance < target_reflectance*(1.0 - min_pass) and target_standard != "ICC IECC 2015"
              ...
              elsif solar_reflectance > target_reflectance*(1.0 + max_pass) and target_standard != "ICC IECC 2015"
